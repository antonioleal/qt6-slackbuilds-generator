...
These packages depend on *cmake-opt* available at SlackBuils.org. Install this one first then proceed to install the Qt official prebuilt environment, available in the folder *qt-prebuilt-environment*.
